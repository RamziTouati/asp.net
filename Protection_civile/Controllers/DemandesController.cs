...
namespace Protection_civile.Controllers
{
    ...
    public class DemandesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,nom,prenom,tel,numcin,nomentreprise,adresse,type,categorie,Date,numdemande,numrecu")] Demande demande)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,nom,prenom,tel,numcin,nomentreprise,adresse,type,categorie,Date,numdemande,numrecu")] Demande demande)
        {
            if (id != demande.Id)
            {
                return NotFound();
